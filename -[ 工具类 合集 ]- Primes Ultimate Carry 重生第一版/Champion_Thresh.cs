...
namespace Primes_Ultimate_Carry
{
	...
	class Champion_Thresh : Champion
	{
		...
		private void LoadMenu()
		{
			...
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "Combo").AddItem(new MenuItem("useQ_Combo_follow", "= Follow Q").SetValue(true));
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "Combo").AddItem(new MenuItem("useW_Combo_Shield", "= Use W Shield at x%").SetValue(new Slider(40, 100, 0)));
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "Combo").AddItem(new MenuItem("useW_Combo_Engage", "= Use W for Engage").SetValue(true));
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "Combo").AddItem(new MenuItem("useE_Combo", "= E to Me till % health").SetValue(new Slider(10, 100, 0)));
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "Combo").AddItem(new MenuItem("useR_Combo_minHit", "= Use R if Hit").SetValue(new Slider(2, 5, 0)));
			...
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "Harass").AddItem(new MenuItem("useW_Harass_safe", "= Use W for SafeFriend").SetValue(true));
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "Harass").AddItem(new MenuItem("useE_Harass", "= E to Me till % health").SetValue(new Slider(90, 100, 0)));
			...
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "Misc").AddItem(new MenuItem("useQ_Interrupt", "= Q to Interrupt").SetValue(true));
