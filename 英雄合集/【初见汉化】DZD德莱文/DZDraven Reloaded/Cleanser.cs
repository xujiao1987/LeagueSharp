...
namespace DZDraven_Reloaded
{
    class Cleanser
    {
        ...
        {
            DZDraven_Reloaded.Menu.SubMenu("QSST").AddItem(new MenuItem("stun", "鐪╂檿銆€").SetValue(true));
            DZDraven_Reloaded.Menu.SubMenu("QSST").AddItem(new MenuItem("charm", "榄呮儜銆€").SetValue(true));
            DZDraven_Reloaded.Menu.SubMenu("QSST").AddItem(new MenuItem("taunt", "鍢茶銆€").SetValue(true));
            DZDraven_Reloaded.Menu.SubMenu("QSST").AddItem(new MenuItem("fear", "鎭愭儳銆€").SetValue(true));
            DZDraven_Reloaded.Menu.SubMenu("QSST").AddItem(new MenuItem("snare", "闄烽槺銆€").SetValue(true));
            DZDraven_Reloaded.Menu.SubMenu("QSST").AddItem(new MenuItem("silence", "娌夐粯銆€").SetValue(true));
            DZDraven_Reloaded.Menu.SubMenu("QSST").AddItem(new MenuItem("supression", "鍘嬫姂銆€").SetValue(true));
            DZDraven_Reloaded.Menu.SubMenu("QSST").AddItem(new MenuItem("polymorph", "鍙樺舰銆€").SetValue(true));
            DZDraven_Reloaded.Menu.SubMenu("QSST").AddItem(new MenuItem("blind", "鑷寸洸銆€").SetValue(false));
            DZDraven_Reloaded.Menu.SubMenu("QSST").AddItem(new MenuItem("slow", "鍑忛€熴€€銆€").SetValue(false));
            DZDraven_Reloaded.Menu.SubMenu("QSST").AddItem(new MenuItem("poison", "姣掋€€").SetValue(false));
        }
