...
namespace FioraRaven
{
    class Fiora
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            menu = new Menu("|鍒濊姹夊寲-鍓戝К|","Fiora",true);
            menu.AddSubMenu(new Menu("|鍒濊姹夊寲-璧扮爫|","Orbwalker1"));
            ...
            menu.SubMenu("Misc").AddItem(new MenuItem("SecondQDelay", "浜屾Q寤惰繜(ms)").SetValue(new Slider(650, 0, 4000)));
            menu.AddSubMenu(new Menu("|鍒濊姹夊寲-鐗╁搧|", "Item"));
            ...
            menu.AddSubMenu(new Menu("|鍒濊姹夊寲-鑷姩韬查伩鍗遍櫓娉曟湳|", "DangSpells"));
...
menu.SubMenu("by chujian").AddItem(new MenuItem("qunhao1", "浜ゆ祦缇わ細333399"));           
            Game.PrintChat("Fiora The Raven By DZ191 鍔犺浇鎴愬姛!by銆€鍒濊姹夊寲锛歈Q銆€5011477 ");
            menu.AddToMainMenu();
