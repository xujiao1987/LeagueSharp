    ...
    class Program
    {
        ...
        private static void OnGameLoad(EventArgs args)
        {
            try
            {
                ...
                Config = new Menu("特效换肤", "Skin Changer", true);
                ...
                var SwitchSkin = Config.AddItem(new MenuItem("keySwitch", "换肤开关").SetValue(new KeyBind("9".ToCharArray()[0], KeyBindType.Press)));
