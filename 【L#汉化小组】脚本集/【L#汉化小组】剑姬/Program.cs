...
namespace FioraRaven
{
    class Fiora
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            menu.SubMenu("Misc").AddItem(new MenuItem("SecondQDelay", "二段Q延迟(ms)").SetValue(new Slider(650, 0, 4000)));
            menu.AddSubMenu(new Menu("物品", "Item"));
