...
namespace FedCaitlyn
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config = new Menu("女警" + ChampionName, ChampionName, true);
            ...
            Config.AddSubMenu(new Menu("Q设置", "Piltover"));
            ...
            Config.AddSubMenu(new Menu("E技能设置", "90 Caliber"));
            ...
            Config.AddSubMenu(new Menu("R设置", "Ace Hole"));
