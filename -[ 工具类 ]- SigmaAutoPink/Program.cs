...
namespace SigmaAutoPink
{
    class Program
    {
        ...
        {
            Config = new Menu("SigmaPinkWard", "SigmaPinkWard", true);
            Config.AddSubMenu(new Menu("Active", "Active"));
            Config.SubMenu("Active").AddItem(new MenuItem("active", "Active!").SetValue(new KeyBind(32, KeyBindType.Press)));
