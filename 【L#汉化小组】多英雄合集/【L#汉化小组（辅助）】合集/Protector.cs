...
namespace Support
{
    ...
    internal class Protector
    {
        ...
        {
		    Game.PrintChat("<font color=\"#00BFFF\">====== 包含英雄====== </font>");
			Game.PrintChat("<font color=\"#00BFFF\">ㄧ牛头ㄧ机器人ㄧ布隆ㄧ末日ㄧ风女ㄧ天启者ㄧ曙光ㄧ露露ㄧ莫甘娜ㄧ娜美ㄧ琴女ㄧ宝石ㄧ锤石ㄧ时光ㄧ婕拉ㄧ</font>");
		    Menu = new Menu("Support: ??????", "Protector", true);
