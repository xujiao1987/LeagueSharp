		...
		private void LoadMenu()
		{
			var champMenu = new Menu("Annie Plugin", "Annie");
			{
				var comboMenu = new Menu("连招", "Combo");
				{
					...
					comboMenu.AddItem(new MenuItem("R_StunCount", "最少晕倒X人").SetValue(new Slider(2, 1, 5)));
				...
				var harassMenu = new Menu("骚扰", "Harass");
				{
					...
					harassMenu.AddItem(new MenuItem("Q_Lasthit_Harass", "使用Q补兵").SetValue(true));
					harassMenu.AddItem(new MenuItem("Q_Lasthit_Harass_stun", "使用Q击晕").SetValue(false));
				...
				{
					lasthitmenu.AddItem(new MenuItem("Q_Lasthit_Lasthit", "使用Q补兵").SetValue(true));
					lasthitmenu.AddItem(new MenuItem("Q_Lasthit_Lasthit_stun", "使用Q击晕").SetValue(true));
					champMenu.AddSubMenu(lasthitmenu);
				}

				var miscMenu = new Menu("杂项", "Misc");
				{
					miscMenu.AddItem(new MenuItem("E_AgainAA", "E开启AA").SetValue(true));
					miscMenu.AddItem(new MenuItem("E_InBase", "E攒晕").SetValue(true));
					miscMenu.AddItem(new MenuItem("Q_Interrupt", "使用Q打断").SetValue(true));
					miscMenu.AddItem(new MenuItem("W_Interrupt", "使用W打断").SetValue(true));
					miscMenu.AddItem(new MenuItem("R_Interrupt", "使用R打断").SetValue(true));
					miscMenu.AddItem(new MenuItem("Q_GapClose", "使用Q防突").SetValue(true));
					miscMenu.AddItem(new MenuItem("W_GapClose", "使用W防突").SetValue(true));
					miscMenu.AddItem(new MenuItem("R_GapClose", "使用R防突").SetValue(true));
