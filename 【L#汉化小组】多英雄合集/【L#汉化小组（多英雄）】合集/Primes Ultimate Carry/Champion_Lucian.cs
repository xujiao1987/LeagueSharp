...
namespace Primes_Ultimate_Carry
{
	...
	class Champion_Lucian : Champion
	{
		...
		{
			ChampionMenu.AddSubMenu(new Menu("模式", PUC.Player.ChampionName + "Modes"));
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "Modes").AddItem(new MenuItem("sep0", "====== 模式"));
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "Modes").AddItem(new MenuItem("use_Mode", "= 模式").SetValue(new StringList(new[] { "Gangster", "Gentlemen", "Hybrid" })));
			...
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "Combo").AddItem(new MenuItem("useE_Combo_maxrange", "= ?最大范围内的敌人ㄧ").SetValue(new Slider(1100, 2000, 500)));
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "Combo").AddItem(new MenuItem("useR_Combo", "= 使用 R").SetValue(true));
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "Combo").AddItem(new MenuItem("useR_Combo_Filler", "= R 如果在CD").SetValue(true));
			...
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "LaneClear").AddItem(new MenuItem("useW_LaneClear", "= 使用 W").SetValue(true));
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "LaneClear").AddItem(new MenuItem("useE_LaneClear", "= 使用 E").SetValue(true));
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "LaneClear").AddItem(new MenuItem("useE_LaneClear_maxrange", "= E 最大范围的小兵").SetValue(new Slider(1100, 2000, 500)));
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "LaneClear").AddItem(new MenuItem("useE_LaneClear_dangerzones", "= E 危险区域???").SetValue(false));
			...
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "RunLikeHell").AddItem(new MenuItem("useE_RunLikeHell_passive", "= 忽略被动").SetValue(true));
			...
			ChampionMenu.SubMenu(PUC.Player.ChampionName + "Misc").AddItem(new MenuItem("usePassive_care", "= 使用被动").SetValue(true));
