...
namespace KarthusRForRAWR
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            menu.SubMenu("Keys")
               .AddItem(
                   new MenuItem("wTar", "对选中目标W").SetValue(new KeyBind("W".ToCharArray()[0],
                       KeyBindType.Press)));
            menu.SubMenu("Keys")
                .AddItem(
                    new MenuItem("lastHitQ", "Q补兵").SetValue(new KeyBind("A".ToCharArray()[0],
                        KeyBindType.Press)));
            menu.SubMenu("Keys")
                .AddItem(
            ...
            menu.SubMenu("Spell").SubMenu("QSpell").AddItem(new MenuItem("qAA", "自动Q目标").SetValue(new KeyBind("I".ToCharArray()[0], KeyBindType.Toggle)));
            menu.SubMenu("Spell").SubMenu("QSpell").AddItem(new MenuItem("qImmo", "自动Q不动").SetValue(true));
            menu.SubMenu("Spell").SubMenu("QSpell").AddItem(new MenuItem("qDash", "自动Q突进").SetValue(true));
            //W
            menu.SubMenu("Spell").AddSubMenu(new Menu("WS", "WSpell"));
            menu.SubMenu("Spell").SubMenu("WSpell").AddItem(new MenuItem("wTower", "塔下自动W").SetValue(true));
            menu.SubMenu("Spell").SubMenu("WSpell").AddItem(new MenuItem("wIfMana", "有蓝才W").SetValue(true));
            //E
            menu.SubMenu("Spell").AddSubMenu(new Menu("E", "ESpell"));
            menu.SubMenu("Spell").SubMenu("ESpell").AddItem(new MenuItem("eManaCombo", "连招min蓝量").SetValue(new Slider(10, 0, 100)));
            menu.SubMenu("Spell").SubMenu("ESpell").AddItem(new MenuItem("eManaHarass", "骚扰min蓝量").SetValue(new Slider(70, 0, 100)));
            //R
            menu.SubMenu("Spell").AddSubMenu(new Menu("R", "RSpell"));
            menu.SubMenu("Spell").SubMenu("RSpell").AddItem(new MenuItem("rPing", "可杀自动提示").SetValue(true));
            ...
            menu.SubMenu("Harass").AddItem(new MenuItem("minMana", "Min蓝量 >").SetValue(new Slider(60, 0, 100)));
            ...
            menu.SubMenu("Drawings").AddItem(new MenuItem("drawUlt", "显示可杀").SetValue(true));
            menu.SubMenu("Drawings")
