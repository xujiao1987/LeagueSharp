...
namespace AniviaReborn
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            menu.SubMenu("Combo").AddItem(new MenuItem("ignite", "点燃").SetValue(true));
            menu.SubMenu("Combo")
                .AddItem(new MenuItem("igniteMode", "模式").SetValue(new StringList(new[] {"Combo", "KS"}, 0)));

            //Harass menu:
            menu.AddSubMenu(new Menu("骚扰", "Harass"));
            menu.SubMenu("Harass").AddItem(new MenuItem("UseQHarass", "使用Q").SetValue(false));
            ...
            menu.SubMenu("Harass").AddItem(new MenuItem("UseRHarass", "使用R").SetValue(true));
            ...
            menu.SubMenu("Farm").AddItem(new MenuItem("UseRFarm", "使用R").SetValue(false));

            //Misc Menu:
            menu.AddSubMenu(new Menu("杂项", "Misc"));
            menu.SubMenu("Misc").AddItem(new MenuItem("UseInt", "打断").SetValue(true));
            ...
            menu.SubMenu("Misc").AddItem(new MenuItem("checkR", "自动关R").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("detonateQ", "自动引爆Q").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("detonateQ2", "身后扔Q").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("wallKill", "可杀用W").SetValue(true));
