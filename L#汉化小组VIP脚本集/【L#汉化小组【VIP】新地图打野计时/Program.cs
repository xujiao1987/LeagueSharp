...
namespace JungleTimerHax
{
    internal class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            (Config = new Menu("新地图打野计时", "JungleTimers420", true)).AddToMainMenu();
            ...
            Game.PrintChat(
                "<font color='#70DBDB'>Dev - </font><font color='#FFFFFF'>JungleTimers420</font> <font color='#70DBDB'> Loaded!</font>");
