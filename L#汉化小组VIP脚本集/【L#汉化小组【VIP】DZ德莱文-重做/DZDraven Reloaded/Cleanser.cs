...
namespace DZDraven_Reloaded
{
    class Cleanser
    {
        ...
        public static void CreateTypeQSSMenu()
        {
            ...
            DZDraven_Reloaded.Menu.SubMenu("QSST").AddItem(new MenuItem("supression", "压制").SetValue(true));
            ...
            DZDraven_Reloaded.Menu.SubMenu("QSST").AddItem(new MenuItem("poison", "中毒").SetValue(false));
        }

        public static void CreateQSSSpellList()
        {
            /**Danger Level 5 Spells*/
            qssSpells.Add(new QSSSpell { ChampName = "Warwick", isEnabled = true, SpellBuff = "InfiniteDuress", SpellName = "狼人R", onlyKill = false });
            qssSpells.Add(new QSSSpell { ChampName = "Zed", isEnabled = true, SpellBuff = "zedulttargetmark", SpellName = "劫R", onlyKill = true });
            qssSpells.Add(new QSSSpell { ChampName = "Rammus", isEnabled = true, SpellBuff = "PuncturingTaunt", SpellName = "龙龟E", onlyKill = false });
            /** Danger Level 4 Spells*/
            qssSpells.Add(new QSSSpell { ChampName = "Skarner", isEnabled = true, SpellBuff = "SkarnerImpale", SpellName = "蝎子R", onlyKill = false });
            qssSpells.Add(new QSSSpell { ChampName = "Fizz", isEnabled = true, SpellBuff = "FizzMarinerDoom", SpellName = "鱼人R", onlyKill = false });
            qssSpells.Add(new QSSSpell { ChampName = "Galio", isEnabled = true, SpellBuff = "GalioIdolOfDurand", SpellName = "哨兵R", onlyKill = false });
            qssSpells.Add(new QSSSpell { ChampName = "Malzahar", isEnabled = true, SpellBuff = "AlZaharNetherGrasp", SpellName = "蚂蚱R", onlyKill = false });
            /** Danger Level 3 Spells*/
            qssSpells.Add(new QSSSpell { ChampName = "Zilean", isEnabled = false, SpellBuff = "timebombenemybuff", SpellName = "时光Q", onlyKill = true });
            qssSpells.Add(new QSSSpell { ChampName = "Vladimir", isEnabled = false, SpellBuff = "VladimirHemoplague", SpellName = "吸血鬼R", onlyKill = true });
            qssSpells.Add(new QSSSpell { ChampName = "Mordekaiser", isEnabled = true, SpellBuff = "MordekaiserChildrenOfTheGrave", SpellName = "铁男R", onlyKill = true });
            /** Danger Level 2 Spells*/
            qssSpells.Add(new QSSSpell { ChampName = "Poppy", isEnabled = true, SpellBuff = "PoppyDiplomaticImmunity", SpellName = "波比R", onlyKill = false });
        }
