...
namespace DZDraven_Reloaded
{
    ...
    public class xSLxOrbwalker
    {
        ...
        public static void AddToMenu(Menu menu)
        {
            ...
            menuDrawing.AddItem(new MenuItem("orb_Draw_AARange", "平A").SetValue(new Circle(true, Color.FloralWhite)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_AARange_Enemy", "敌人平A").SetValue(new Circle(true, Color.Pink)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_Holdzone", "安全区域").SetValue(new Circle(true, Color.FloralWhite)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_MinionHPBar", "小兵血格|").SetValue(new Circle(true, Color.Black)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_MinionHPBar_thickness", "厚度").SetValue(new Slider(1, 1, 3)));
            ...
            menuDrawing.AddItem(new MenuItem("orb_Draw_nearKill", "可杀小兵").SetValue(new Circle(true, Color.Gold)));
            menu.AddSubMenu(menuDrawing);

            var menuMisc = new Menu("杂项", "orb_Misc");
            menuMisc.AddItem(new MenuItem("orb_Misc_Holdzone", "防守区域").SetValue(new Slider(50, 100, 0)));
            menuMisc.AddItem(new MenuItem("orb_Misc_Farmdelay", "补兵延迟").SetValue(new Slider(0, 200, 0)));
            menuMisc.AddItem(new MenuItem("orb_Misc_ExtraWindUp", "额外时间").SetValue(new Slider(80, 200, 0)));
