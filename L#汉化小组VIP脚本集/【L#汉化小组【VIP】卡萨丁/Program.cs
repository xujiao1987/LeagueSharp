...
namespace BlackKassadin
{
    class Program
    {
        ...
        private static void createMenu()
        {
            ...
            harass.AddItem(new MenuItem("harassUseE", "使用E").SetValue(false));
            ...
            killsteal.AddItem(new MenuItem("killstealUseE", "使用E").SetValue(false));
            ...
            misc.AddItem(new MenuItem("miscUltToMouse", "R向鼠标|").SetValue(new KeyBind('G', KeyBindType.Press)));
            misc.AddItem(new MenuItem("miscUseR", "连招R向鼠标|").SetValue(true));
            misc.AddItem(new MenuItem("miscUltStacks", "E层数")).SetValue(new Slider(3, 1, 4));
            ...
            drawings.AddItem(new MenuItem("drawRangeE", "E/R范围").SetValue(new Circle(false, Color.Aquamarine)));
