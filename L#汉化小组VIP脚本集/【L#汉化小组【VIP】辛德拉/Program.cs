...
namespace GagongSyndra
{
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Base menu
            Menu = new Menu("辛德拉", "GagongSyndra", true);
            ...
            Menu.SubMenu("Harass").AddItem(new MenuItem("HarassMana", "蓝量控制").SetValue(new Slider(0, 0, 100)));
            ...
            Menu.SubMenu("QEsettings").AddItem(new MenuItem("QEMR", "QE Max范围%").SetValue(new Slider(100, 0, 100)));
            ...
            Menu.SubMenu("Rsettings").AddSubMenu(new Menu("可击杀的", "DontRw"));
            Menu.SubMenu("Rsettings").SubMenu("DontRw").AddItem(new MenuItem("DontRwParam", "损害").SetValue(new StringList(new[] { "All", "Either one", "None" }, 0)));
            ...
            Menu.SubMenu("Drawing").AddItem(new MenuItem("KillTextHP", "连招损伤文本").SetValue(true));
